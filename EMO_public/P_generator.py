       ...
       Offspring[Offspring < MinValue] = MinValue[Offspring < MinValue]
        ...
        for i in range(0, N, 2):
            ...
            for j in range(2):
                ...
                #find that only use mutation_indicator with lowprob i%5=0 5% and others highprob 95% --- final 97.25% CIFAR-10, WHY...
                if i % 5 != 0:   #240508 add ; 240715 changed
                    print(i, " high mutation prob")
                    muta_indicator_1,muta_indicator_2 = mutation_indicator_high(p1.copy(),p2.copy(),op_index)
...
def mutation_indicator(solution_1,solution_2, op_index):
    ...
    # print('len(solution_1) and len(op_index_1)',len(solution_1),len(op_index_1))
    # print('len(solution_2) and len(op_index_2)',len(solution_1),len(op_index_1))
    # 88 11; 25 5; 75 10; etc.
...
def mutation_indicator_high(solution_1,solution_2, op_index):
...
def mutation(solution,op_index,Num_Op):
    ...
    Num_Op = int(Num_Op)  ## 0516 add, need an integer  
    op_candidate = []
